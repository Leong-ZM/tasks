...
public class Main {
    public static void main(String[] args) {
        ...
        System.out.println("Printing deadlines before sort ...");
        printDeadlines(tasksData);
        System.out.println("Printing deadlines after sort ...");
        printDeadlinesUsingStream(tasksData);

        System.out.println("Total number of deadlines: " +
                countDeadlines(tasksData) + countDeadlinesUsingStream(tasksData));
